...
import { LayoutDashboard, Package, ShoppingCart, Settings, Menu as MenuIcon, Navigation, X, Home, ChevronRight, LogOut } from 'lucide-react'
      ...
      <aside className={cn(
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="p-4 border-t border-sidebar-border space-y-1">
            <Link
              href="/"
              className="flex items-center gap-2 px-2 py-2 rounded-xl text-sidebar-foreground hover:text-sidebar-primary hover:bg-sidebar-accent transition-colors"
            >
              <Home size={18} />
